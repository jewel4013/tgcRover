    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
         ...
         <div class="mt-4 form-group">
            ...
            <x-text-input id="avatar" class="form-control-file block mt-1 w-full" type="file" name="avatar" :value="old('avatar')" files="true" enctype="multipart/form-data" required/>
