...
<head>
  ...
  <title>Jewel Dashboard</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{ asset('css/admin_css/OverlayScrollbars.min.css') }}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ asset('img/rover_logo.png') }}" alt="AdminLTELogo" height="60" width="60">
    <span>Loading...</span>
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
      <img src="{{ asset('img/rover_logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">TGC Rover</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('img/profilePic/'.Auth::user()->avatar) }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fa-solid fa-tents"></i>
              <p>
                Events
                <i class="right fas fa-angle-left"></i>
              </p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023-2024 <a href="https://www.tgcrover.com">Tongi Govt College Rover & Girl-in Rover Unit</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Developed by: </b> <a href="https://www.facebook.com/jewelrana4013" class="">Jewel Rana</a>
    </div>
  </footer> --}}
</div>
